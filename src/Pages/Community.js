...
const Community = () => {
  ...
  const author="xxx"
  const paragraph="Few things are as rowdy and reckless as college spring break. Each year swarms of students make a pilgrimage to America's southern beach towns for a week-long party. According to Airlines for America, a trade group, this year an astonishing 2.6m Americans are expected to fly on each day of March and April-a number boosted, no doubt, by spring-break travel. Many of their destination-cities are dreading their arrival.Miami Beach never wanted spring-breakers. This year, as partiers flooded the beach, things got raucous. On March 19th, after two consecutive"
  return (
    <div className="h-[100%] bg-[#fff7e4]">
      ...
      <div className="mt-20 flex justify-center mx-10">
        <div >
        <p className="text-3xl text-[#f58220] font-bold pb-4">Title:{title}</p>
